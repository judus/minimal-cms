...
function CheckAuthentication()
{
	...
	return (isset($ci_session['username']) && !empty($ci_session['username']));
}
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => '256M',
		'allowedExtensions' => '7z,aiff,asf,avi,bak,bmp,cpr,csv,dls,doc,docx,eps,fla,flv,gif,gz,gzip,jpeg,jpg,mid,midi,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,peak,pdf,png,ppt,pptx,psd,pxd,qt,ram,rar,riff,rm,rmi,rmvb,rtf,sdc,sitd,smf,svg,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,xmf,zip',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		'name' => 'Photoshop',
		'url' => $baseUrl . 'psd',
		'directory' => $baseDir . 'psd',
		'maxSize' => '256M',
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,psd,ai,svg,tif,tiff,eps',
		'deniedExtensions' => '');
